...
cv::Mat complexDotMultiplicationSIMD(const cv::Mat &a, const cv::Mat &b)
{
	...
	/*
    ar = (float *)calloc(h * w, sizeof(float));
    ai = (float *)calloc(h * w, sizeof(float));
    br = (float *)calloc(h * w, sizeof(float));
    bi = (float *)calloc(h * w, sizeof(float));
    rr = (float *)calloc(h * w, sizeof(float));
    ri = (float *)calloc(h * w, sizeof(float));
	*/
